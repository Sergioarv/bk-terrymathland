...
public interface EstudianteRepository extends JpaRepository<Estudiante, Integer> {
    ...
    @Query(value = "select * from estudiante as e inner join respuesta as r on r.idusuario = e.idusuario where lower(e.nombre) like lower(concat('%',:nombre,'%')) and r.fecha = :fecha", nativeQuery = true)
